...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        player = this.physics.add.sprite(100, 600, 'player');  //"player" (Name des Bildes fuer Player)
        player.setScale(2);   //Hier wird die Grosse des Spielers veraendert/gesetzt -> 1 = urspruengliche Groesse
